...
var es6_regexp_replace = __webpack_require__(81);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es6.string.starts-with.js
var es6_string_starts_with = __webpack_require__(87);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es7.symbol.async-iterator.js
var es7_symbol_async_iterator = __webpack_require__(91);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es6.symbol.js
var es6_symbol = __webpack_require__(92);

// EXTERNAL MODULE: ./node_modules/core-js/modules/web.dom.iterable.js
var web_dom_iterable = __webpack_require__(98);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es6.array.iterator.js
var es6_array_iterator = __webpack_require__(57);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es6.object.to-string.js
var es6_object_to_string = __webpack_require__(103);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es6.string.iterator.js
var es6_string_iterator = __webpack_require__(104);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es6.weak-map.js
var es6_weak_map = __webpack_require__(105);

// EXTERNAL MODULE: ./node_modules/regenerator-runtime/runtime.js
var runtime = __webpack_require__(113);
		...
		.replace(ALL_SCRIPT_REGEX, function(match) {
			...
			if (SCRIPT_TAG_REGEX.test(match)) {
				...
				*/
				...
				var code = Object(utils["b" /* getInlineCode */])(match);
		...
		styles.map(function(styleLink) {
			if (styleLink.startsWith('<')) {
				...
				return (
					...
					(styleCache[styleLink] = axios_default.a.get(styleLink).then(function (response) {
	...
	return Promise.all(
		scripts.map(function(script) {
			if (script.startsWith('<')) {
				...
				return (
					scriptCache[script] ||
					(scriptCache[script] = axios_default.a.get(script).then(function(response){
						return response.data
					}))
				);
			}
...
function execScripts(entry, scripts, proxy) {
	return getExternalScripts(scripts).then(function(scriptsText){
		...
		function execs(scriptSrc, inlineScript, resolve) {
			var markName = 'Evaluating script '+scriptSrc+'';
			var measureName = 'Evaluating Time Consuming: '+scriptSrc+'';
			...
			var exports = proxy[Object(utils["a" /* getGlobalProp */])()] || {};
			resolve(exports);
		...
		function schedule(i, resolvePromise) {
			if (i < scripts.length) {
				...
				execs(scriptSrc, inlineScript, resolvePromise);
            ...
            /* compileCode('' + entry.join(' ') + '')(window.proxy); */
            geval(';(function(window){;'+entry.join(' ')+'\n})(window);');
					}
...
function importHTML(url,options) {
	...
	return (
		embedHTMLCache[url] ||
		(embedHTMLCache[url] = axios_default.a.get(url)
			...
			.then(function(html){
				...
				return getEmbedHTML(template, styles).then(function(embedHTML) {
					...
					execScripts:function(proxy){return execScripts(entry, scripts)}
				})});
			}))
	);
}
